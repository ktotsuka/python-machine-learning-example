...
# Get the validation curve using scikit-learn tool
param_range = [0.001, 0.01, 0.1, 1.0, 10.0, 100.0]
train_scores, test_scores = validation_curve(estimator=pipe_lr, 
                                             X=X_train, 
                                             y=y_train, 
                                             param_name='logisticregression__C',  # C, inverse of the regularization parameter
...
plt.xlabel('Parameter C (inverse of regularization parameter)')
plt.ylabel('Accuracy')
plt.ylim([0.8, 1.0])
plt.tight_layout()
